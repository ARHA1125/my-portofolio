        ...
        <section id="contact" className="border-t border-border py-16">
          <Reveal>
            <div className="rounded-[20px] border border-border bg-surface p-9">
              <h2 className="mb-3 font-sans text-[22px] font-medium text-bg">Get in touch</h2>
              <p className="mb-6 max-w-[440px] text-bg">
                Open to internship or entry-level data science opportunities. Feel free to reach out if you&apos;d like to talk or collaborate.
              </p>
              <p className="mb-6 max-w-[440px] text-bg">Email me: alvinrh.adriano@gmail.com</p>
             
            <div className="flex items-center gap-4">
              <div className="social-button">
                <a href="https://www.instagram.com/arha1125" target="_blank" rel="noopener noreferrer">
                <button className="relative w-12 h-12 rounded-full group">
                  <div
                   className="floater w-full h-full absolute top-0 left-0 bg-gradient-to-tr from-[#fdf497] via-[#fd5949] to-[#285aeb] rounded-full duration-300 group-hover:-top-8 group-hover:shadow-2xl"
              ...
              <div className="social-button">
                <a href="https://www.github.com/arha1125" target="_blank" rel="noopener noreferrer">
                <button className="relative w-12 h-12 rounded-full group">
                  <div
              ...
              <div className="social-button">
                <a href="https://shorturl.at/goVXP" target="_blank" rel="noopener noreferrer">
                <button className="relative w-12 h-12 rounded-full group">
                  <div
              ...
              <div className="social-button">
                <a href="alvinrh.adriano@gmail.com" target="_blank" rel="noopener noreferrer">
                <button className="relative w-12 h-12 rounded-full group">
                  <div
